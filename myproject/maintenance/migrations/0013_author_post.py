...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('maintenance', '0012_alter_work_request_work_order'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='default.png', null=True, upload_to='auther-image/')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='maintenance.author')),
